...
$_ADMINLANG['utilities']['emailCampaigns']['immediately'] = "מיידי";
...
$_ADMINLANG['taxconfig']['euTaxExemptDescription'] = "ניכוי מס אוטומטי ללקוחות שעברו בהצלחה תהליך אימות של מספר הח.פ. / עוסק מורשה";
...
$_ADMINLANG['configservers']['newWizardIntro'] = "זהו האשף החדש ליצירת שרתים כאשר כולל בתוכו השלמה אוטומטית של שדות נתמכים. אתם מעדיפים את האשף הקודם? <a href='#'' class='alert-link'>לחצו כאן</a>";
...
$_ADMINLANG['mail']['error']['systemUrlMissing'] = "אנא הגדר כתובת אתר של מערכת בהגדרות הכלליות. הגדרה זו נדרשת עבור כמה אפשרויות תצורה של ספקי דואר אלקטרוני.";
