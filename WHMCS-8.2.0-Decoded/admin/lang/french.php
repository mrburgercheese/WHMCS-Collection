...
$_ADMINLANG['products']['slugInUse'] = "Slug already in-use";
$_ADMINLANG['products']['invalidSlug'] = "Invalid Slug";
$_ADMINLANG['products']['slugInvalidEmpty'] = "Invalid Format: Slugs must not be empty";
$_ADMINLANG['products']['slugInvalidFormat'] = "Invalid Format: Slugs must include at least 1 letter";
...
$_ADMINLANG['mail']['error']['systemUrlMissing'] = "Please configure a System URL in General Settings. This setting is required for some Mail Provider configuration options.";
