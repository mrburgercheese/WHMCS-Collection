...
$_LANG['store']['save'] = "Guardar :saving%";
...
$_LANG['marketConnect']['spamexperts']['manageEmail'] = "Administre su Correo Electrónico";
$_LANG['marketConnect']['weebly']['buildWebsite'] = "Construya su sitio web";
