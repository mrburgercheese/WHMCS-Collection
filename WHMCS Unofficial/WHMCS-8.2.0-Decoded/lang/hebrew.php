...
$_LANG['store']['ssl']['landingPage']['faq']['a5'] = "תעודות SSL  עם אימות מורחב (EV) הן הרמה הגבוהה ביותר של תעודות SSL  הקיימות היום. הן משדרות אמינות וביטחון מרביים לגולשים באתר שלכם – יותר מכל תעודת SSL אחרת. תעודות אלו כוללות מאפיינים כגון צביעת שורת הכתובת בצבע ירוק והצגה של שם החברה שלכם כחלק משורת הכתובת. מאפיינים אלו נמצאו טובים במיוחד להגברת האמון ותחושת הביטחון של לקוחות הגולשים באתר שלכם.";
...
$_LANG['marketConnect']['spamexperts']['manageEmail'] = "ניהול דואר אלקטרוני";
$_LANG['marketConnect']['weebly']['buildWebsite'] = "בנו את האתר שלכם";
...
$_LANG['ox']['intro'] = "כאן ביכולתכם ליצור ולנהל את המשתמשים ואת תיבות הדואר האלקטרוני עבור חבילת האפליקציות של או אקס שרכשתם.";
